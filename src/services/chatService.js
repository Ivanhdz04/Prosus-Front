...
export const chatService = {
  ...
  async getGroupMessageById(messageId) {
    const response = await api.get(`/group-chat/${messageId}`)
    return response.data
  },

  async getMessagesByGroup(groupId) {
    const response = await api.get(`/group-chat/group/${groupId}`)
    return response.data
  },

  async getUserMessagesInGroup(groupId, userId) {
    const response = await api.get(`/group-chat/group/${groupId}/user/${userId}`)
    return response.data
  },

  async sendGroupMessage(messageData) {
    const response = await api.post('/group-chat/', messageData)
    return response.data
  },

  async updateGroupMessage(messageId, messageData) {
    const response = await api.put(`/group-chat/${messageId}`, messageData)
    return response.data
  },

  async deleteGroupMessage(messageId) {
    const response = await api.delete(`/group-chat/${messageId}`)
    return response.data
  },

  async toggleGroupMessageStatus(messageId) {
    const response = await api.patch(`/group-chat/${messageId}/toggle`)
    return response.data
  },
  ...
  async getAIMessagesByGroup(groupId) {
    const response = await api.get(`/ia_chat/group/${groupId}`)
    return response.data
  },
